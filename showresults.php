            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <center><span class="title">Search Suspect</span>
                        <div class="description">Search For A Suspect In The Database</div></center>
                    </div>
                    <div class="row">
                        <div class="col-xs-12" >
                            <div class="card" >
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Suspect Arrests</div>
                                    </div>
                                </div>
                                <div class="card-body" >
									...
									<thead>
										...
										$result = mysql_query("SELECT crime_name, crime_deputy, crime_report, crime_date FROM crimes");
										if (false === $result) {
											echo mysql_error();
										}
                                     ...
                                     <tbody>
                                       <tr>
                                           <td><?php echo $row['crime_name'] ?></td>
                                             <td><?php echo $row['crime_deputy'] ?></td>
                                            <td><?php echo $row['crime_report'] ?></td>
