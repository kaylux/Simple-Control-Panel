...
<body class="flat-blue">
    <div class="app-container">
            ...
            <div class="container-fluid">
                <div class="side-body padding-top">
                    <div class="row">
                                ...
                                <div class="card red summary-inline">
                                    <div class="card-body">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="sub-title">Total Arrests</div>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <a href="wwarrants.php">
                                <div class="card green summary-inline">
                                    <div class="card-body">
                                        <i class="icon fa fa-tags fa-4x"></i>
                                        <div class="content">
                                            <div class="title">4</div>
                                            <div class="sub-title">Warrants</div>
                                        </div>
                                        <div class="clear-both"></div>
                                    </div>
                                </div>
                    ...
                    <div class="row  no-margin-bottom">
                                ...
                                <div class="col-xs-12">
                                    <div class="card primary">
                                        ...
                                        <div class="card-body half-padding">
                                            ...
                                            <h2 class="float-right no-margin font-weight-300">Crime Information</h2>
                                            <div class="clear-both"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="thumbnail no-margin-bottom">
                                        <img src="views/panel/img/thumbnails/picjumbo.com_IMG_4566.jpg" class="img-responsive">
                                        <div class="caption">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="thumbnail no-margin-bottom">
                                        <img src="views/panel/img/thumbnails/picjumbo.com_IMG_3241.jpg" class="img-responsive">
                                        <div class="caption">
                                            <h3 id="thumbnail-label">Thumbnail label<a class="anchorjs-link" href="#thumbnail-label"><span class="anchorjs-icon"></span></a></h3>
                                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="row">
                               ...
                               <div class="col-md-6 col-sm-12">
									<center>
                                        <img src="images/skins/288.jpg" class="img-responsive">
                                    </center>   
                            ...
                            <div class="card card-success">
                                ...
                                <div class="card-body no-padding">
                                    <ul class="message-list">
                                        <a href="#">
                                            <li>
                                                <img src="views/panel/img/profile/profile-1.jpg" class="profile-img pull-left">
        ...
        <div>
            ...
            <!-- Javascript -->
            <script type="text/javascript" src="views/panel/js/app.js"></script>
            <script type="text/javascript" src="views/panel/js/index.js"></script>
			<script type="text/javascript" src="views/panel/js/chartjs.js"></script>
</body>
