                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="panel panel-default dropdown">
                                ...
                                <div id="dropdown-element" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li><a href="grid.html">Add Person</a>
                                            </li>
                                            <li><a href="views/panel/html/grid.html">Search Person</a>
                                            </li>
                                            <li><a href="views/panel/html/ui-kits/button.html">Update Details</a>
                                            </li>
                            ...
                            <li class="panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-icon">
                                    <span class="icon fa fa-archive"></span><span class="title">Dispatch Information</span>
                                </a>
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <center><span class="title">Report A Crime</span>
                        <div class="description">Adding A Crime Into The Database</div></center>
                    </div>
                    <div class="row">
                        <div class="col-xs-12" >
                            <div class="card" >
                                ...
                                <div class="card-body" >
                                    ...
                                    <form action="classes/addsuspect.php" method="post">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="suspect_ethnicity" placeholder="Attempted Murder of A LEO" required>
                                        </div>
                                    
                                    	<div class="form-group">
                                            <label for="exampleInputEmail1">Location Of Arrest</label>
                                            <input type="text" class="form-control" name="suspect_sex" placeholder="Fort Carson" required>
                                        </div>
