...
echo " session  running " . $_SESSION['userName'];
}
?>
<head>
                            ...
                            <div class="card" >
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Enter Suspect Name</div>
                                    </div>
                                </div>
                                <div class="card-body" >
                                    ...
                                    <form action="showresults.php" method="post">
                                        ...
                                        <center><button type="submit" name="searchsuspect" class="btn btn-default">Submit</button> </center>
                                    </form>
                                </div>
                            </div>
                        </div>
